...
// Custom icon components as SVG replacements for lucide-react
// This avoids loading lucide-react from blob URL which fails in v0 preview
...
export const Sparkles = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path d="M9.26 9a2.5 2.5 0 0 1 3.48 0l8.26 8.26a2.5 2.5 0 0 1-3.54 3.54L9.26 12.54a2.5 2.5 0 0 1 0-3.54z" />
    <path d="M6.04 6.04a3 3 0 0 1 4.24 0l10.06 10.06a3 3 0 1 1-4.24 4.24L6.04 10.28a3 3 0 0 1 0-4.24z" />
  </svg>
)
...
export const Building2 = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path d="M6 22V4a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v18M6 12h12M6 16h12" />
...
export const Globe = (props: React.SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path d="M12 2a14.3 14.3 0 0 1 3.53 7M2 12a14.3 14.3 0 0 1 7-3.53M2 12a14.3 14.3 0 0 0 7 3.53M12 2a14.3 14.3 0 0 0-3.53 7" />
  </svg>
)
...
export const ExternalLink = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6M9 3h12v12" />
  </svg>
)
...
export const LogOut = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-2M9 12h12M9 12l3-3m-3 3l3 3" />
  </svg>
)
...
export const Twitter = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M23 3a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1A10.66 10.66 0 013 4s-4 9 5 13a11.64 11.64 0 01-7 2s9 5 20 5a9.5 9.5 0 00-9-5.5c4.75 2.25 7-7 7-7s1.1 1 2-3a4.5 4.5 0 01-1.3-4.5z" />
  </svg>
)
...
// Icons from shadcn/ui that need to be replaced
...
// For backward compatibility with shadcn UI components
export const X = XIcon
export const ArrowLeftIcon = ArrowLeft
export const ArrowRightIcon = ArrowRight
export const BookOpenIcon = BookOpen
export const UsersIcon = Users
export const BookText = FileText
export const Palette = (props: React.SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <circle cx="5.5" cy="12.5" r=".5" fill="currentColor" />
...
export const Sparkles2 = Sparkles

// Missing exports - adding ChevronLeft variants
